...
func GetForumThemeMessages(s *ss.Session, TID, page, pageSize string) (*dt.ForumThemeMessages, error) {
	p := "http://"
...
func CreateForumTheme(s *ss.Session, page, name, message string) error {
	p := "http://"
