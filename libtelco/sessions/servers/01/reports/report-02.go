...
func GetAverageMarkReport(s *dt.Session, dateBegin, dateEnd, Type, studentID string) (*dt.AverageMarkReport, error) {
	p := "http://"
	...
	return reportsparser.AverageMarkReportParser(bytes.NewReader(b))
}
