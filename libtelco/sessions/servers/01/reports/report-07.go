...
func GetJournalAccessReport(s *dt.Session, studentID string) (*dt.JournalAccessReport, error) {
	p := "http://"
	...
	return reportsparser.JournalAccessReportParser(bytes.NewReader(b))
}
