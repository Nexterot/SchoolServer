...
func GetAverageMarkDynReport(s *dt.Session, dateBegin, dateEnd, Type, studentID string) (*dt.AverageMarkDynReport, error) {
	p := "http://"
	...
	r1 := func() (bool, error) {
		...
		return check.CheckResponse(s, r1)
	}
	flag, err = r1()
	if err != nil {
	...
	return reportsparser.AverageMarkDynReportParser(bytes.NewReader(b))
}
