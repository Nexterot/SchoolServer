...
func GetStudentGradeReport(s *dt.Session, dateBegin, dateEnd, subjectID, studentID string) (*dt.StudentGradeReport, error) {
	p := "http://"
	...
	return reportsparser.StudentGradeReportParser(bytes.NewReader(b))
}
