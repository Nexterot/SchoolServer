...
func GetStudentTotalReport(s *dt.Session, dateBegin, dateEnd, studentID string) (*dt.StudentTotalReport, error) {
	p := "http://"
	...
	return reportsparser.StudentTotalReportParser(bytes.NewReader(b))
}
