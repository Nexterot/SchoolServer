...
func GetLessonDescription(s *dt.Session, AID, CID, TP int, studentID, classID, serverAddr string, db *red.Database) (*dt.LessonDescription, error) {
	p := "http://"
...
func getFile(s *dt.Session, lessonDesc *dt.LessonDescription, classID, ID, serverAddr string, db *red.Database) (*dt.LessonDescription, error) {
	p := "http://"
