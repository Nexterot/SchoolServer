...
// getReportStudentAverageMarkDynRequest используется в GetReportStudentAverageMarkDynHandler
type getReportStudentAverageMarkDynRequest struct {
	ID   int    `json:"id"`
...
func (rest *RestAPI) GetReportStudentAverageMarkDynHandler(respwr http.ResponseWriter, req *http.Request) {
	...
	var rReq getReportStudentAverageMarkDynRequest
