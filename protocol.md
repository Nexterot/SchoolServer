...
#### 2.4.7 Получение отчета "Отчет о доступе к классному журналу".
...
#### 2.4.8 Отчет "Информационное письмо для родителей".

### 2.4.8.1 Получение данных для отчета "Информационное письмо для родителей".
...
### 2.4.8.2 Получение отчета "Информационное письмо для родителей".
